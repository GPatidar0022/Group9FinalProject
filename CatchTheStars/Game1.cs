...
namespace CatchTheStars
{
    public class Game1 : Game
    {
        ...
        private int score = 0;
        private float timer = 60f; // 60-second timer
        ...
        protected override void LoadContent()
        {
            ...
            playerTexture = Content.Load<Texture2D>("player"); // Ensure correct name (no file extension)
            starTexture = Content.Load<Texture2D>("star");
            obstacleTexture = Content.Load<Texture2D>("obstacles");
            gameFont = Content.Load<SpriteFont>("gameFont"); // Ensure Font.spritefont exists in Content
